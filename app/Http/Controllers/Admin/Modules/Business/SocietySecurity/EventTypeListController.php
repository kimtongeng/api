...
class EventTypeListController extends Controller
{
    ...
    public function store(Request $request)
    {
        if (Permission::authorize(self::MODULE_KEY, Permission::getCreatePermission())) {
            ...
            $business_category->{BusinessCategory::TYPE} = BusinessCategoryType::getEventType();
    ...
    public function getAutoOrder()
    {
        ...
        $data = BusinessCategory::where('business_category.business_type_id', BusinessTypeEnum::getNews())
